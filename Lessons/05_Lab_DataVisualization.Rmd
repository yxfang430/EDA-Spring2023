...
ggplot(PeterPaul.chem.nutrients, 
  ...
  geom_bar() + # Create 12 levels for 12 months, even though some levels are empty
  # labels = month.abb shows the labels in three-letter month
  scale_x_discrete(drop=FALSE) + # drop = F can display the empty levels
  labs(title = 'My Plot',
       x = 'Month') # Change the x labels
