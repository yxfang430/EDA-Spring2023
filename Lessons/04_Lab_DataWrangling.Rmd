...
NTL.phys.data_1990_1999 <- NTL.phys.data %>%
  filter(lakename == 'Tuesday Lake' & 1989 < year4 & year4 < 2000) 
...
NTL.phys.data_july <- NTL.phys.data %>%
  mutate(month = month(sampledate)) %>%
  filter(lakename == 'Tuesday Lake' & 1989 < year4 & year4 < 2000 & month == 7) 
#filter(lakename == 'Tuesday Lake' & 1989 < year4 & year4 < 2000 & month(sampledate) == 7)
...
NTL.phys.data_july_mean <- NTL.phys.data_july %>%
...
NTL.phys.data.Ex5 <- NTL.phys.data %>%
  pivot_longer(irradianceDeck:irradianceWater, 
               names_to = 'Irradiance_Type', values_to = 'Irradiance_Value')

#NTL.phys.data.Ex5 <- NTL.phys.data %>%
#  pivot_longer(c(irradianceDeck,irradianceWater), 
#              names_to = 'Irradiance_Type', values_to = 'Irradiance_Value')
