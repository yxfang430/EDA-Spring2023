...
theURL2 <- 'https://waterdata.usgs.gov/nwis/uv?search_site_no=02085070&period=24&format=rdb' # period = days
...
nc_pop <- 
  get_acs(geography = "county",
          ...
          state = "NC",
          geometry = TRUE) # geometry = true, give a spatial dataframe
...
df <- data.frame(the_states, the_price, the_capacity, net_generation, TotalRetail = as.numeric(gsub(",","",total_retail)))
```
